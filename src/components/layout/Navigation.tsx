...
const Navigation = () => {
  ...
  return (
    <header className="full-width content-grid fixed z-50 size-full h-24 bg-white">
      <div className="flex-between">
        ...
        {/* MOBILE NAVLINKS */}
        <nav
          className={`${openNav ? "block" : "hidden"} absolute right-0 top-full z-50 w-full space-y-6 bg-white p-4`}
        >
